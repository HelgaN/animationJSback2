...
var ParticleEngine = (function() {
	...
	function ParticleEngine(canvas_id) {
		...
		this.particleSettings = [{id:"small", num:400, fromX:0, toX:this.totalWidth, ballwidth:3, alphamax:0.4, areaHeight:.5, color:"#e4ca70", fill:false},
								{id:"medium", num:100, fromX:0, toX:this.totalWidth,  ballwidth:8, alphamax:0.3, areaHeight:1, color:"#f4c422", fill:true},
								{id:"large", num:15, fromX:0, toX:this.totalWidth, ballwidth:30,  alphamax:0.2, areaHeight:1, color:"#e6dbb6", fill:true}];
		this.particleArray = [];
		this.lights = [{ellipseWidth: 20, ellipseHeight:80, alpha:0.2, offsetX:80, offsetY:-50, color:"#e4e0d0"}];
		...
		{
			circle.speed = range(1, 6);
			circle.initY = weightedRange(0, _ParticleEngine.totalHeight , 4, [_ParticleEngine.totalHeight * (2-areaHeight/2)/4, _ParticleEngine.totalHeight*(2+areaHeight/2)/4], 0.8 );
			circle.initX = weightedRange(positionX, totalWidth, 4, [positionX+ ((totalWidth-positionX))/4, positionX+ ((totalWidth-positionX)) * 3/4], 0.6);
		}
